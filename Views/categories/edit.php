                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <form action="index.php?controller=category&action=update" method="POST" class="p-8 space-y-6">
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4" class="w-full bg-gray-50 border border-gray-200 rounded-xl p-3 text-sm focus:ring-primary focus:border-primary"><?php echo htmlspecialchars($category['desc'] ?? ''); ?></textarea>
                            </div>
