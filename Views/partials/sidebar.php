...
<aside id="sidebar" class="sidebar-transition fixed inset-y-0 left-0 z-50 w-64 bg-black border-r border-zinc-800 transform -translate-x-full lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto">
    ...
    <nav class="mt-6 px-4 pb-8 space-y-6">
        ...
        <div class="space-y-1">
            ...
            <a href="index.php?controller=sync" class="flex items-center px-3 py-2 text-xs font-semibold rounded-lg transition-all <?php echo isActive('sync', 'index') ? 'text-white bg-zinc-900' : 'text-zinc-400 hover:text-white hover:bg-zinc-900/50'; ?>">
